...
public class GuiZweitlösung
{
    ...
    public void guizweitlösunweitlösung(){
        ...
        knopf1.setFont(new Font("SansSerif", Font.PLAIN, 12));
        ...
        knopf2.setFont(new Font("SansSerif", Font.PLAIN, 12));
        ...
        knopf3 = new JButton("-");
        knopf3.setFont(new Font("SansSerif", Font.PLAIN, 12));
        ...
        knopf4 = new JButton ("--");
        knopf4.setFont(new Font("SansSerif", Font.PLAIN, 12));
